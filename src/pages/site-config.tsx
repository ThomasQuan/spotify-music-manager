                ...
                <ol className="mt-8 space-y-6">
                    <li className="space-y-2">
                        ...
                        <p className={clsx("!mt-1 text-sm", textColor)}>
                            You can change primary color to any Tailwind CSS colors. See globals.css
                    ...
                    <li className="space-y-2">
                        ...
                        <p className={clsx("!mt-1 text-sm", textColor)}>
                            No style applied, differentiate internal and outside links, give custom
                            cursor for outside links.
                        </p>
                    ...
                    <li className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Button variant="outline" isDarkBg={true}>
                                Outline Variant
                            </Button>
                            <Button variant="ghost" isDarkBg={true}>
                                Ghost Variant
                            </Button>
                            <Button variant="dark">Dark Variant</Button>
                            <Button variant="light">Light Variant</Button>
                            <Button variant="transparent" isDarkBg={true}>
                                Transparent
                            </Button>
                        </div>
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Button disabled variant="outline" isDarkBg={true}>
                                Disabled
                            </Button>
                            <Button disabled variant="ghost" isDarkBg={true}>
                                Disabled
                            </Button>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Button isLoading variant="outline" isDarkBg={true}>
                                Disabled
                            </Button>
                            <Button isLoading variant="ghost" isDarkBg={true}>
                                Disabled
                            </Button>
